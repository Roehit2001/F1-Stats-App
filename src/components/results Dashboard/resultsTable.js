    ...
    return (
        <div className="col-12 mt-5 resultsTab">
            <div className="header-year row">
                <p className="float-left font-weight-bold col-md-4">{year}</p>
                <p className="text-center font-weight-bold col-md-4">{moment(results.MRData.RaceTable[0].Race[0].Date, "YYYY-MM-DD").format('DD MMM YYYY')}</p>
                <p className="text-right font-weight-bold col-md-4">Round: {round}</p>
            </div>
                                ...
                                if (result.Time) {
                                    return (
                                        <tr key={result.$.position} className="">
                                            ...
                                            <td><span className="perNum">{result.Driver[0].PermanentNumber}</span>{result.Driver[0].GivenName + " " + result.Driver[0].FamilyName}</td>
