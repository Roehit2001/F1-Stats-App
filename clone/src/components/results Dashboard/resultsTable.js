...
const ResultsTable = ({ results, year, round }) => {
    if (results.length === 0) {
        return (
            <div className="card raceresults h-100">
                <h2>Loading..</h2>
            </div>
        )
    }
    return (
        <div className="col-12 mt-5">
            ...
            <table id="ResultsTable_Table" className="table table-hover table-sm  table-bordered">
                <thead>
                ...
                <tbody >
                    {
                        ...
                        results.MRData.RaceTable[0].Race[0].ResultsList[0].Result.map(result => {
                            if (result.Time) {
                                return (
                                    <tr key={result.$.position} className="table-info">
